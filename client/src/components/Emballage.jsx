...
import EditVerifEmballage from "./EditVerifEmballage";
...
const Emballage = () => {
  ...
  const getVerifications = () => {
    setIsLoading(true);
    axios
      .get("http://localhost:3001/vemballage/vemballage")
      .then((res) => {
  ...
  const handleEditVerification = () => {
    ...
    axios
      .put(
        `http://localhost:3001/vemballage/vemballage/${editedVerificationId}`,
  ...
  return (
   <div className="hero">
     <div className="appc">
     <div className="work">
     <EditVerifEmballage verifications={verifications} handleDelete={handleDelete} />
